...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <table width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="2" valign="middle" class="header">
          <div class="header-logo">
            <a href="http://resolutionproductionsgroup.com/echo/"><img src="../img/logo.png" /></a>
          </div>
      ...
      <tr>
        <td colspan="2">
          <div id="footer">&copy; <?php echo date("Y"); ?> <a href="http://chrisvuletich.com">ChrisVuletich.com</a>, All Rights Reserved.<br />Powered by CCMS.</div>
        </td>
      </tr>
    </table>
    <br />
